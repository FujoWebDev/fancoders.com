...
<a href="#join" class="button button--outline button--custom fullWidth">Join us!</a>
...
- [The Fujoshi Guide to Web Development](https://www.fujoweb.dev/), a series of
  instructional zines to help fans get up and running with modern coding
- [AO3.js](https://github.com/Fandom-Coders/AO3.js), a library to support coding
  projects that interact with Archive of Our Own
- [BobaBoard](https://www.bobaboard.com/), a community-developed social network
  by fans, for fans
...
Alternatively, reach out to [Ms. Boba](https://www.essentialrandomness.com/).
All current members also have the ability to invite new ones.
